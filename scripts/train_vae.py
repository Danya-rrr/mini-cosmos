"""
VAE training script with mixed precision and gradient accumulation.
"""
...
class VAETrainer:
    ...
    def train(self, epochs, resume=None):
        ...
        print(f"Batch: {self.train_loader.batch_size} x {self.grad_accum_steps} = {self.train_loader.batch_size * self.grad_accum_steps}")
        ...
        for epoch in range(start_epoch, epochs):
            ...
            print(f"  Train | Loss: {train_metrics['loss']:.4f} | Recon: {train_metrics['recon']:.4f} | KL: {train_metrics['kl']:.2f}")
            print(f"  Val   | Loss: {val_metrics['loss']:.4f} | Recon: {val_metrics['recon']:.4f} | KL: {val_metrics['kl']:.2f}")
