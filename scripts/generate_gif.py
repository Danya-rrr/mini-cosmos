...
Generates animated comparisons of predicted vs ground truth frames for
visualizing World Model prediction quality.
"""
...
def tensor_to_numpy(tensor):
    """Convert tensor to uint8 numpy image array."""
...
class GIFGenerator:
    """
    Generator for creating prediction visualization GIFs.
    ...
    def create_gif(self, context_frames, predicted_frames, ground_truth_frames=None,
        ...
        Context frames have blue borders, predictions have green borders,
        and ground truth frames have yellow borders.
        """
        frames_for_gif = []
        ...
        target_width = w * 2 if include_comparison and ground_truth_frames is not None else w
...
def main():
    ...
    print(f"\n[OK] Generated {args.num_samples} GIFs in {output_dir}")
