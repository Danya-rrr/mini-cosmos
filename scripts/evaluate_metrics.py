...
Computes prediction quality metrics including SSIM, PSNR, MSE, and LPIPS
for autoregressive future frame prediction.
"""
...
class MetricsEvaluator:
    """
    Evaluator for computing prediction quality metrics.
    
    Args:
        vae: Trained VAE model
        world_model: Trained World Model
        device: Device for computation
        use_lpips: Whether to compute LPIPS metric
    """
    ...
    def evaluate_sample(self, context_frames, gt_future_frames,
        ...
        """Evaluate prediction quality for a single sample."""
...
def evaluate_model(evaluator, dataset, num_samples, num_future, context_length, device):
    """Evaluate model on multiple samples from dataset."""
    all_metrics = {
...
def plot_metrics(results, output_dir):
    """Generate and save metrics visualization plots."""
